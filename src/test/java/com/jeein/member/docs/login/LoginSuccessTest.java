...
import static com.jeein.member.docs.snippets.CommonSnippet.CommonDescriptor.successResponseWithDataFields;
...
public class LoginSuccessTest {
    ...
    void login_withInvalidEmail_shouldReturnForbidden() throws Exception {
        ...
        mockMvc.perform(post(ApiPath.MEMBER_LOGIN).content(objectMapper.writeValueAsString(loginRequest)))
                ...
                .andDo(doc(LOGIN_SUCCESS_CASE, MEMBER_LOGIN_REQUEST_FIELDS, successResponseWithDataFields()));
    }
}
