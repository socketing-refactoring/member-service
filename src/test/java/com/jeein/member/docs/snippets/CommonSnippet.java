...
public class CommonSnippet {
    ...
    public class CommonDescriptor {
        ...
        public static final FieldDescriptor ERRORS = fieldWithPath("errors")
                .optional()
                .type("array")
                .description("유효성 검사 실패 필드 목록");
        ...
        public static final FieldDescriptor SUCCESS_DATA = fieldWithPath("errors").optional().description("응답 값");
        ...
        public static ResponseFieldsSnippet successResponseWithDataFields() {
            return responseFields(
                    SUCCESS_CODE, SUCCESS_MESSAGE, SUCCESS_DATA,
                    DATA_ID, DATA_NAME, DATA_NICKNAME, DATA_EMAIL
            );
        }
    }
}
